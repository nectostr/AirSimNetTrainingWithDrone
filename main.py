...
ROWS = 256
COLS = 256
load_path = "L:\\Documents\PyCharmProjects\\HelloDrone\\data5"
load_amount = 200

param1 = 'generate' # load
param2 = 'offline' # online
param3 = 'train' # test
...
print(model.summary())
keras.utils.plot_model("L:\\Documents\PyCharmProjects\\HelloDrone\\modelplot.png")
...
if param3 == 'train':
    ...
    while ep < 400:
        try:
            print(ep)
            history = model.fit_generator(generator, epochs=epochs, steps_per_epoch=10, verbose=1, workers=1)
            if ep % 10 == 0:
